// $Id$
/*
 * Copyright (C) 2010 sk89q <http://www.sk89q.com> All rights reserved.
 */
...
public class WorldGuardVehicleListener implements Listener {
	...
	public void onVehicleDestroy(VehicleDestroyEvent event) {
		...
		if (wcfg.useRegions) {
			...
			if (!plugin.getGlobalRegionManager().hasBypass(player, world) && !set.canBuild(localPlayer) && !set.allows(DefaultFlag.DESTROY_VEHICLE, localPlayer)) {
