...
public class BukkitUtil {
	 ...
	 * @deprecated see
	 *             {@link WorldGuardPlugin#matchSinglePlayer(org.bukkit.command.CommandSender, String)}
	...
	public static boolean isIntensiveEntity(Entity entity) {
		return entity instanceof Item || entity instanceof TNTPrimed || entity instanceof ExperienceOrb || entity instanceof FallingSand || (entity instanceof LivingEntity && !(entity instanceof Tameable) && !(entity instanceof Player));
	}
	...
	/** Search an enum for a value, and return the first one found. Return null if the enum entry is
	 * not found.
	 * 
