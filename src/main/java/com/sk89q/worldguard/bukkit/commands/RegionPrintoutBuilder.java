...
public class RegionPrintoutBuilder {
	...
	public void appendFlagsList(boolean useColors) {
		...
		for (Flag<?> flag : DefaultFlag.getFlags()) {
			...
			if (group == null) {
				builder.append(flag.getName()).append(": ").append(String.valueOf(val));
			}
			else {
				builder.append(flag.getName()).append(" -g ").append(String.valueOf(group)).append(": ").append(String.valueOf(val));
			}
