...
public class ProtectedCuboidRegion extends ProtectedRegion {
	 ...
	 * if (region instanceof ProtectedCuboidRegion) { ProtectedCuboidRegion r1 =
	 * (ProtectedCuboidRegion) this; ProtectedCuboidRegion r2 = (ProtectedCuboidRegion) region;
	 * BlockVector min1 = r1.getMinimumPoint(); BlockVector max1 = r1.getMaximumPoint(); BlockVector
	 * min2 = r2.getMinimumPoint(); BlockVector max2 = r2.getMaximumPoint(); return !(min1.getBlockX()
	 * > max2.getBlockX() || min1.getBlockY() > max2.getBlockY() || min1.getBlockZ() >
	 * max2.getBlockZ() || max1.getBlockX() < min2.getBlockX() || max1.getBlockY() < min2.getBlockY()
	 * || max1.getBlockZ() < min2.getBlockZ()); } else if (region instanceof ProtectedPolygonalRegion)
	 * { throw new UnsupportedIntersectionException(); } else { throw new
	 * UnsupportedIntersectionException(); } }
	 */
