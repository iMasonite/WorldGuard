...
public class RegionUtil {
	 ...
	 * @deprecated see
	 *             {@link RegionDBUtil#addToDomain(com.sk89q.worldguard.domains.DefaultDomain, String[], int)} */
	@Deprecated
	 ...
	 * @param startIndex The index to start at
	 * @deprecated see
	 *             {@link RegionDBUtil#removeFromDomain(com.sk89q.worldguard.domains.DefaultDomain, String[], int)} */
	@Deprecated
