...
public abstract class RegionOverlapTest {
	...
	void setUpCourtyardRegion() {
		...
		// ProtectedRegion region = new ProtectedCuboidRegion(COURTYARD_ID, new BlockVector(0, 0, 0),
		// new BlockVector(10, 10, 10));
	...
	void setUpFountainRegion() throws Exception {
		...
		ProtectedRegion region = new ProtectedCuboidRegion(FOUNTAIN_ID, new BlockVector(0, 0, 0), new BlockVector(5, 5, 5));
	...
	void setUpNoFireRegion() throws Exception {
		ProtectedRegion region = new ProtectedCuboidRegion(NO_FIRE_ID, new BlockVector(100, 100, 100), new BlockVector(200, 200, 200));
		manager.addRegion(region);
